    ...
    <Layout>
      ...
      <section className="relative h-96 text-white bg-black overflow-hidden">
        <video
          ...
          src="/the-royal-dwelling/luxury.mp4"
        />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-lg leading-relaxed mb-6">
                To provide innovative, modern, and healthier spaces that enhance
                the way people live, work, and connect with their communities.
                We are committed to creating sustainable developments that
                contribute to vibrant, modern cities of tomorrow.
              </p>
            ...
            <div className="group relative overflow-hidden rounded-2xl border border-[#D4AF37]/30 h-80 md:h-[380px] lg:h-[420px] shadow-2xl">
              <video
                ...
                playsInline
              >
                <source src="/the-royal-dwelling/luxury2.mp4" type="video/mp4" />
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="group relative overflow-hidden rounded-lg border-4 border-transparent hover:border-[#D4AF37] transition-all duration-500 hover:scale-105 shadow-[0_10px_30px_rgba(0,0,0,0.3)] hover:shadow-[0_15px_40px_rgba(212,175,55,0.4)]">
              <img
                src="/the-royal-dwelling/luxury3.jpg"
            ...
            <div>
              ...
              <p className="text-lg mb-6">
                We pioneer smart, eco‑conscious residential plot developments
                tailored for India's vision of sustainable living that connect
                communities and preserve nature.
              </p>
